...
export default {
  data() {
    return {
      ...
      clock: null,
      mixers: [],
      MODELS: [{ name: "Soldier" }, { name: "Parrot" }],
      UNITS: [
        {
  ...
  methods: {
    ...
    initScene() {
      ...
      this.worldScene.background = new THREE.Color(0xa0a0a0);
      this.worldScene.fog = new THREE.Fog(0xa0a0a0, 10, 22);
